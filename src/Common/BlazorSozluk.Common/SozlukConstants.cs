...
namespace BlazorSozluk.Common
{
    public class SozlukConstants
    {
        ...
        public const string CreateEntryCommentFavQueueName = "CreateEntryCommandFavQueue";
        public const string CreateEntryCommentVoteQueueName = "CreateEntryCommandVoteQueue";
