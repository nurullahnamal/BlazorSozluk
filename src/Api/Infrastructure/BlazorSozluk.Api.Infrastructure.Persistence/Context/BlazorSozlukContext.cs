...
namespace BlazorSozluk.Api.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connStr = @"server=DESKTOP-CHMVP03\SQLEXPRESS;database=blazorsozluk;integrated security=true;";
        ...
        private void OnBeforeSave()
        {
            ...
            PrapareAddedEntities(addedEntites);
        }

        private void PrapareAddedEntities(IEnumerable<BaseEntity> entities)
        {
